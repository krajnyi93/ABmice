...
#            act_laps_dF = self.cell_activelaps_df[i_corridor]
    ...
    def plot_lap_by_lap(self, /, selected_laps=None, filename=None, only_imaged = False, show=True) -> Figure:
        return self.plot_session(selected_laps=selected_laps, average=False, filename=filename, only_imaged=only_imaged, show=show)
